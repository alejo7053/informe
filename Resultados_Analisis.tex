...
\begin{figure}[H]
	...
	\label{fig:views}
	\subfigure[Usuario Administrador]{\includegraphics[width=0.95\linewidth]{Imagenes/Admin_view}}
	\subfigure[Usuario de Casa]{\includegraphics[width=0.49\linewidth]{Imagenes/UserH_view}}
	\subfigure[Usuario de Habitación]{\includegraphics[width=0.49\linewidth]{Imagenes/UserR_view}}
\end{figure}
