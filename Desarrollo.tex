...
En los siguientes ítems se resaltaran las características más importantes que lleva el circuito:\\
	...
	\subsubsection{Calibración de audio:}
		Para calibrar la salida audible se hace uso de una resistencia variable (Potenciometro), con el cual se disminuye el ruido causado aparentemente por la red eléctrica presente en el entorno de aplicación.\\
