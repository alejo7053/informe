...
En los siguientes ítems se resaltaran las características más importantes que lleva el circuito:\\
	...
	\subsubsection{Calibración de audio:}
		Para calibrar la salida audible se hace uso de una resistencia variable (Potenciometro), el cual permite regular el voltaje de entrada al circuito de amplificación, mostrado en la figura \ref{fig:AUD}, el cual será descrito en el presente capitulo en la sección de salidas del hardware.\\
	...
	\subsubsection{Salida audible:}
		...
		Como se mencionó anteriormente, el circuito presenta un potenciómetro a la entrada para calibrar el 
		.\\
