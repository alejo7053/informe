...
\end{figure}
	...
	\paragraph{Sensores:}
		...
		\begin{figure}[H]
			...
			\label{fig:SVS}
			\subfigure[Entrada Sensores]{\includegraphics[width=0.5\linewidth]{Imagenes/SVS}}
			\subfigure[Entrada para sensor de calidad de aire]{\includegraphics[width=0.4\linewidth]{Imagenes/S1Aire}}
		\end{figure}
	...
	\paragraph{Botón enable:}	Presionando el botón enable se reinicia la aplicación y la tarjeta ESP32.	
...
Además, la aplicación a desarrollar se puede observar en la Figura \ref{fig:App}, este diagrama explica, en el caso de los sensores, cada uno tiene una tarea para la lectura y gestión de datos, así como también ocurre de manera similar con las salidas de la tarjeta, pues cuentan con tareas encargadas de la gestión del encendido y apagado, asimismo para el control de cargas, ya sea por ángulo de fase o PWM. Antes de realizar las funciones de la aplicación se procede a configurar el framework, sus componentes y algunas partes del freeRTOS.\\
...
%
%Para el desarrollo se la base de datos se plantea el modelo que se observa en la Figura \ref{fig:DB}, es un bosquejo de qué tablas se usan para almacenar los datos y las diferentes relaciones que posee, en el capítulo de resultados se presenta con más detalle como quedo estructura la base de datos. Para este desarrollo se tienen en cuenta los modelos mencionados anteriormente, como también ciertos campos que permitan identificar los roles y demás información relevante hacia los datos que se almacenan, como las medidas de los sensores o los estados de las salidas.
%
%\begin{figure}[H]
%	\centering
%	\caption{Base de datos SmartHouse [Imagen Propia]}
%	\label{fig:DB}
%	\includegraphics[width=0.75\linewidth]{Imagenes/DB0}
%\end{figure}
